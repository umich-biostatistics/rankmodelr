...
case23_ranked <- read_csv(file="data/case23_20Dec2014.csv",col_names=F,na="",skip=4,n_max=32);
colnames(case23_ranked) <- colnames(read_csv(file="data/case23_20Dec2014.csv",col_names=T,na="",skip=2,n_max=1));
...
#Case 111 ----
#Read in data; remove tail columns that are empty
case111_ranked <- read_csv(file="data/case111_20Dec2014.csv",col_names=F,na="",skip=4,n_max=32);
colnames(case111_ranked) <- colnames(read_csv(file="data/case111_20Dec2014.csv",col_names=T,na="",skip=2,n_max=1));
...
#Case 83 ----
#Read in data; remove tail columns that are empty
case83_ranked <- read_csv(file="data/case83_20Dec2014.csv",col_names=F,na="",skip=4,n_max=32);
colnames(case83_ranked) <- colnames(read_csv(file="data/case83_20Dec2014.csv",col_names=T,na="",skip=2,n_max=1));
